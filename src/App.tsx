...
type BilingualString = { ko: string; th: string };
type Question = {
...
const questions: Question[] = [
  // 🐾 사회성(S)
  {
    ...
    options: {
      ...
      th: [
        "“นี่ถิ่นของฉันนะ” ทำหน้าดุใส่",
        "หายตัวทันที ไปซ่อนก่อน",
        "ยืนไกลๆ เงียบๆ แล้วส่อง",
        "ทำเหมือนไม่สน…แต่แอบจับตาอยู่",
        "เดินไปดม ทำความรู้จักก่อน",
      ],
    },
  },
  {
    axis: "S",
    prompt: {
      ko: "집사가 다른 방으로 이동하면 우리 주인님은?",
      th: "ทาสเดินไปอีกห้อง…เจ้านายทำไง?",
    },
    options: {
      ko: [
        "꿈쩍도 하지 않는다",
      ...
      th: [
        "ไม่ขยับเลย เฉยมาก",
        "หันไปมองทีนึงแล้วจบ",
        "คิดแป๊บ…แล้วค่อยเดินตาม",
        "ตามไปเงียบๆ ติดหลังเลย",
        "“ไปไหน?” แล้ววิ่งตามทันที",
      ],
    },
  },
  {
    ...
    options: {
      ...
      th: [
        "ทำเป็นไม่รู้ ทำเป็นหลับ",
        "เหลือบมองแป๊บ แล้วทำของตัวเองต่อ",
        "ค่อยๆ เดินมา…ขอดมก่อน",
        "วนๆ ใกล้ๆ ให้รู้ว่าฉันอยู่",
        "ออกไปรับถึงหน้าประตูเลย",
      ],
    },
  },
  {
    axis: "S",
    prompt: {
      ko: "집사가 한참 자리에 앉아 있다면?",
      th: "ถ้าทาสนั่งนานๆ เจ้านายทำไง?",
    },
    options: {
      ko: [
        "각자 인생이다",
      ...
      th: [
        "ต่างคนต่างอยู่ อย่ามายุ่ง",
        "อยู่ห้องเดียวกัน…แต่ขอเว้นระยะ",
        "แวะมาดมหน่อยแล้วก็ไป",
        "ยึดที่ข้างๆ แบบเนียนๆ",
        "ตักทาส = ที่นั่งประจำ",
      ],
    },
  },
  ...
  // ⚡ 활동성(A)
  {
    axis: "A",
    prompt: {
      ko: "새 장난감을 꺼냈을 때 우리 주인님은?",
      th: "หยิบของเล่นใหม่ออกมา เจ้านายทำไง?",
    },
    options: {
      ko: [
        "전혀 관심 없다",
      ...
      th: [
        "ไม่สนใจเลย",
        "แตะๆ สองทีพอเป็นพิธี",
        "มองนานมาก…แล้วค่อยแตะเบาๆ",
        "วิ่งไล่แบบจริงจัง",
        "ตาเปลี่ยนเป็นโหมดล่า 100%",
      ],
    },
  },
  {
    ...
    prompt: {
      ko: "집 안이 조용할 때 모습은?",
      th: "บ้านเงียบๆ เจ้านายทำอะไรอยู่?",
    },
    options: {
      ko: [
        "거의 움직이지 않는다",
      ...
      th: [
        "แทบไม่ขยับเลย",
        "อยู่มุมเดิมเป็นหลัก",
        "แวะไปดูหน้าต่างเป็นระยะ",
        "เดินสำรวจบ้านบ่อยๆ",
        "เดินตรวจตราทั้งบ้านเหมือนเจ้าของพื้นที่",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    prompt: {
      ko: "낚싯대를 흔들면 반응은?",
      th: "ทาสแกว่งไม้ตกแมว…เจ้านายทำไง?",
    },
    options: {
      ko: [
        "“그건 네가 해.”",
      ...
      th: [
        ...
        "แตะๆ พอเป็นพิธี",
        "ตาตาม…แต่ตัวขอชิล",
        "จ้อง-ย่อง-พุ่ง แบบจริงจัง",
        "ล่าไม่เลิก จนกว่าจะชนะ",
      ],
    },
  },
  ...
  // 🌙 정서안정(E) — Q9~Q11 역문항
  {
    ...
    reverse: true,
    prompt: {
      ko: "청소기를 켰을 때 우리 주인님은?",
      th: "เปิดเครื่องดูดฝุ่นปุ๊บ เจ้านายทำไง?",
    },
    options: {
      ko: [
        "크게 놀라거나 공격적으로 반응한다",
  ...
  },
  {
    ...
    reverse: true,
    prompt: {
      ko: "갑자기 큰 소리가 났을 때 반응은?",
      th: "มีเสียงดังปุ๊บ เจ้านายทำไง?",
    },
    options: {
      ko: [
        "깜짝 놀라 크게 반응한다",
      ...
      th: [
        "สะดุ้งสุดตัว มีอาการชัดเจน",
        "รีบหายไปก่อน",
        "เกร็งๆ คอยดูสถานการณ์",
        "หยุดแป๊บแล้วกลับมาได้",
        "“อะไรนะ?” แล้วก็ชิลต่อ",
      ],
    },
  },
  {
    ...
    reverse: true,
    prompt: {
      ko: "동물병원 가는 날, 우리 주인님은?",
      th: "วันไปหาหมอ…เจ้านายเป็นไง?",
    },
    options: {
      ko: [
        "격렬하게 저항한다",
  ...
  },
  {
    ...
    options: {
      ...
      th: [
        ...
        "ส่องนาน…แล้วค่อยออก",
        "สำรวจแบบระวังๆ",
        "แป๊บเดียวก็ทำเหมือนเป็นบ้านตัวเอง",
      ],
    },
  },
];
...
const results: Record<ResultCode, ResultPack> = {
  SAE: {
    title: { ko: "집사 너무 좋아 💕", th: "ทาสจ๋า ฉันชอบเธอ 💕" },
    oneLiner: { ko: "나는 네가 집이야.", th: "เธอคือ ‘บ้าน’ ของฉันนะทาส" },
    heart: {
  ...
  SAT: {
    title: { ko: "집사야 놀자 ⚡", th: "ทาส! เล่นเดี๋ยวนี้ ⚡" },
    oneLiner: { ko: "지금이야. 지금 놀아줘.", th: "ตอนนี้แหละ…เล่นเลย!" },
    heart: {
  ...
  SCE: {
    title: { ko: "집사야 내가 집주인이지 😼", th: "บ้านนี้ฉันคุม 😼" },
    oneLiner: { ko: "루틴은 사랑이야.", th: "รูทีน = ความรักของทาส" },
    heart: {
    ...
    caution: {
      ko: ["환경 변화가 잦으면 조용히 스트레스가 쌓일 수 있어."],
      th: ["เปลี่ยนของ/ย้ายเฟอร์บ่อยๆ ฉันเครียดสะสมเงียบๆ ได้"],
    },
  },
  SCT: {
    title: { ko: "집사야 간식이 좀 아닌데 👑", th: "ทาส…ขนมไม่ผ่าน 👑" },
    oneLiner: { ko: "내 취향은 분명해.", th: "รสนิยมฉันชัดเจนมากนะ" },
    heart: {
    ...
    caution: {
      ko: ["억지로 ‘좋아해!’ 강요하면 더 거부감이 커질 수 있어."],
      th: ["บังคับให้ ‘ต้องชอบ’ จะยิ่งต่อต้านนะทาส"],
    },
  },
  IAE: {
    title: { ko: "집사… 지금은 새벽이야 🌙", th: "ทาส…ตอนนี้ตีสาม 🌙" },
    oneLiner: { ko: "밤은 나의 시간이야.", th: "กลางคืนคือเวลาของฉัน" },
    heart: {
    ...
    caution: {
      ko: ["야간 활동을 억지로 막기보다 루틴으로 유도해줘."],
      th: ["อย่าห้ามแบบดื้อๆ ตั้งรูทีนให้แทนจะเวิร์กกว่า"],
    },
  },
  IAT: {
    title: { ko: "나는야 독립왕 고양이 👑", th: "ฉันคือราชาเดี่ยว 👑" },
    oneLiner: { ko: "내 생활은 내가 한다.", th: "ชีวิตฉัน ฉันจัดการเอง" },
    heart: {
    ...
    caution: {
      ko: ["억지로 안거나 붙잡으면 관계가 멀어질 수 있어."],
      th: ["จับกอด/บังคับมากไป ความสัมพันธ์จะถอยได้นะ"],
    },
  },
  ICE: {
    title: { ko: "집사야 날 좀 내버려둬 😼", th: "ทาส…ขอพื้นที่หน่อย 😼" },
    oneLiner: { ko: "좋아해. 근데 거리는 필요해.", th: "ชอบนะ…แต่ต้องมีระยะ" },
    heart: {
    ...
    caution: {
      ko: ["억지 스킨십/갑작스런 접근은 스트레스 신호를 만들 수 있어."],
      th: ["กอดฝืนๆ / พุ่งเข้าใส่ทันที ทำให้เครียดได้"],
    },
  },
  ICT: {
    title: { ko: "우리 집사 뭐하나 볼까? 👀", th: "ทาสทำอะไรอยู่…ขอดูหน่อย 👀" },
    oneLiner: { ko: "난 조용히 다 보고 있어.", th: "ฉันเงียบ…แต่เห็นหมดนะ" },
    heart: {
    ...
    caution: {
      ko: ["갑작스런 소음/방문객/가구 이동이 반복되면 예민해질 수 있어."],
      th: ["เสียงดัง/แขกมา/ย้ายของบ่อยๆ อาจทำให้ไวขึ้น"],
    },
  },
};
          ...
          <>
            <div ref={shareCardRef} style={{ padding: 2 }}>
              ...
              >
                ...
                <h2 style={{ margin: "8px 0 6px", letterSpacing: -0.3 }}>{resultPack.title[lang]}</h2>
                ...
                {axisBars.map((b) => (
                  <div key={b.axis} style={{ marginBottom: 12 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, opacity: 0.75 }}>
                      <span>{axisLabel(b.axis, lang)}</span>
